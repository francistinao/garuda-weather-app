  ...
  return (
    <div>
      <nav className='flex justify-between p-4 w-full h-3'>
        ...
        <div className='bg-zinc-700 flex justify-space w-92 h-20 gap-1 p-4 rounded-3xl bg-opacity-60'>
          <IoLocation className='w-auto h-auto text-white'/>
          <div>
            <p className='text-xs text-white pt-2'>Current Location</p>
            <h2 className='text-xl font-bold text-white'>{fetchCity}</h2>
          </div>
        </div>
      </nav>
    </div>
